...
const ViewAssignmentModal: React.FC<ViewAssignmentModalProps> = ({
  ...
  const fetchAssignmentData = async () => {
    ...
    setError('');
    try {
      console.log('📥 Fetching assignment data for view:', assignmentId);
              ...
              <div className="flex items-center gap-3 p-4 bg-blue-50/50 rounded-2xl border border-blue-100">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">
                    {assignment.teacherName || (typeof assignment.teacher === 'object' ? assignment.teacher.name : null) || 'School Admin'}
                  </p>
                </div>
              </div>
