        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 sm:p-8 relative overflow-hidden mx-2 sm:mx-0">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between relative z-10 gap-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 mb-1">Academic Calendar</h1>
                <p className="text-gray-500 text-sm">View school events and holidays, and add your own class events</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="px-5 py-2.5 bg-violet-600 text-white text-sm font-semibold rounded-xl hover:bg-violet-700 transition-all shadow-sm hover:shadow flex items-center justify-center gap-2"
              >
