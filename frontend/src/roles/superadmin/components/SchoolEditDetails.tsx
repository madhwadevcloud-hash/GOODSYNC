    ...
    return (
      <div className="p-4 sm:p-6">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Edit School</h1>
        </div>
    ...
    <div className="p-4 sm:p-6 max-w-6xl mx-auto animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-lg sm:text-2xl font-bold text-gray-900 truncate">Edit: {profile.name}</h1>
        </div>
        <div className="flex gap-2">
          <button onClick={() => setCurrentView('school-details')} className="flex-1 sm:flex-none flex items-center justify-center space-x-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
            <X className="h-4 w-4" />
            <span>Cancel</span>
          </button>
          <button onClick={handleSave} disabled={loading} className="flex-1 sm:flex-none flex items-center justify-center space-x-2 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 disabled:opacity-50">
